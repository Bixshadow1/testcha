...
//JOIN
$kanalimiz = "bixuz";
$kanalimiz1 = "parallel_orzular";
$kanalimiz2 ="mahfiy_sirlar";
$kanalimiz3 ="OLTIN_KUTUBXONA";
...
if($yil == "2020"){
 ...
 $gget = $gett->result->status;
  if($gget == "member" or $gget == "creator" or $gget == "administrator"){
   file_put_contents("azo.txt","✅");
   }else{   
  file_put_contents("azo.txt","❎");
  }
  }
$azo=file_get_contents("azo.txt");
if($azo == "✅"){
...
bot('SendPhoto',[
'chat_id'=>$chat_id, 'reply_to_message_id'=>$mid,
'photo'=>"https://bixuz.asline.ru/CORONA/Corona/ramadan1.php?text=$ex[1]",
'caption'=>"TAYYOR😉😁
created by @Coronaphotobot",
'reply_markup'=>json_encode([
'inline_keyboard'=>[
 ...
 bot('sendmessage', [
      'chat_id' =>$chat_id,
       'text' => "Siz bu kanallarga a'zo bo'lib keyin yana qayta uring. 
Azo bo'lmasangiz botni ishlata ⚜ ololmaysiz. ✋
...
Bizning kanallarimiz🔻" ,
       'parse_mode'=>'markdown', 
        ...
        'inline_keyboard' =>
         [
         [['text' => "📡KANALIMIZ",'url'=>"https://telegram.me/$kanalimiz"]],[['text' => "📡KANALIMIZ",'url'=>"https://telegram.me/$kanalimiz1"]],[['text' => "📡KANALIMIZ",'url'=>"https://telegram.me/$kanalimiz2"]],
[['text' => "📡KANALIMIZ",'url'=>"https://telegram.me/$kanalimiz3"]],
          ]
         ])
      ]); 
      }
